...
echo "<h1><center>Welcome ".$unm."</center></h1>" ;
 ...
 try{
		...
		$sql="select * from soldier where uname='$unm'";
		...
		while($r=$query->fetch()){
			...
			echo "<p style='font-size:200%;'><b>Soldier - Name</b>  :  ".$r['sold_name']."</p>";
			echo "<p style='font-size:200%;'><b>Soldier - id</b>  :  ".$r['id']."</p>";
			echo "<p style='font-size:200%;'><b>Bank Account No</b>  :  ".$r['acc']."</p>";
			echo "<p style='font-size:200%;'><b>Bank Name</b>  :  ".$r['bank']."</p>";
			echo "<p style='font-size:200%;'><b>Balance</b>  :  ".$r['amount']."</p>";
			}
	}
