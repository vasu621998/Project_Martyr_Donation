    ...
    <div class="sp-container">
        <div class="sp-content">
            <div class="sp-globe"></div>
            	<h2 class="frame-1">Patel Prashit:CE 90</h2>

            	<h2 class="frame-2">Patel Pratik:CE 91</h2>

            	<h2 class="frame-3">Patel Vasu:CE 93</h2>

            	<h2 class="frame-4">CE-D1</h2>

            	<h2 class="frame-5"><span>Discrete Maths</span> <span>4th Sem</span> <span>2K17.</span> <br><span>Inspired By Akshay Kumar.</span></h2>
